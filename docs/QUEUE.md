...
- No subscription filters / rules. Every subscription is implicitly match-all.
...
1. **Subscription filters / rules.** SQL + correlation filters, default rule = match-all.
